...
export function ExamSearchFilters() {
  ...
  useEffect(() => {
    ...
    setExamType(searchParams.get("examType") || "all");
  ...
  const applyFilters = () => {
    ...
    router.push(`/exams-controls?${params.toString()}`);
  };
  ...
  return (
    <div className="w-full bg-background border-b mb-8 sticky top-0 z-10 shadow-sm">
      <div className="container py-4">
        <form onSubmit={handleSearch} className="flex flex-col gap-4">
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <Input
                ...
                placeholder="Rechercher un examen, un contrôle..."
                className="pl-10"
              />
            </div>
            <Button
          ...
          {showFilters && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-muted/30 rounded-lg border animate-in slide-in-from-top-2">
