...
import { ArrowLeft, Download, FileText, GraduationCap, Edit } from "lucide-react"
  ...
  return (
    <div className="container py-8 space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        <Link href="/admin/exams" className="hover:text-primary transition-colors">
      ...
      {/* Professional Exam Header - Matching Public/Lesson Header Design */}
